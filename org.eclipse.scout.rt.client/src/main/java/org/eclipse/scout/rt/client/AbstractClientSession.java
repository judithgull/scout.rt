...
public abstract class AbstractClientSession extends AbstractPropertyObserver implements IClientSession, IExtensibleObject {
  ...
  private final ISchedulingSemaphore m_modelJobSchedulingSemaphore = Jobs.newSchedulingSemaphore(1).seal();
  ...
  @Override
  public ISchedulingSemaphore getModelJobSchedulingSemaphore() {
    return m_modelJobSchedulingSemaphore;
  }
